                            ...
                            <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($item->image)
                                                <img src="{{asset('uploads/hero/'.$item->image)}}" alt="{{$item->title}}" width="80">
                                            @else
                                                No Image
                                            @endif
                                        </td>
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-danger waves-effect btn-circle waves-light"
                                      onclick="deleteItem({{ $item->id }});" type="button">
                                        ...
                                        {{-- <td>
                                            <a href="{{ route('hero.edit', $hero->id) }}" class="btn btn-sm btn-warning">Edit</a>
