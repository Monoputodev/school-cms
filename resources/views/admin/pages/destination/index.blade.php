                                                ...
                                                <td>
                                                    @if ($destination->status == 1)
                                                        <a class="btn btn-danger waves-effect btn-circle waves-light"
                                                            href="{{ route('destinations.inactive', $destination->id) }}">
                                                            <i class="fa fa-eye-slash"></i> </a>
                                                    @else
                                                        <a class="btn btn-success waves-effect btn-circle waves-light"
                                                            href="{{ route('destinations.active', $destination->id) }}">
                                                    ...
                                                    <form hidden action="{{ route('destinations.destroy', $destination->id) }}"
                                                        id="form{{ $destination->id }}" method="get">
                                                        @csrf
                                                    </form>
                                                    <button class="btn btn-danger waves-effect btn-circle waves-light"
                                                        onclick="deleteItem({{ $destination->id }});" type="button">
