                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="ranking"
                                          value="{{ $notice->ranking }}" name="ranking" required>
                                    </div>
                                  <div class="col-md-6">
                                  ...
                                  <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="subtitle" name="subtitle" value="{{ $notice->subtitle }}" required>
                                  </div>

                                  <div class="col-md-6">
                                    <label for="pdf_file" class="form-label">PDF FILE</label>
                                    <input type="file" class="form-control dropify" id="pdf_file" name="pdf_file" data-default-file="{{asset('uploads/notices/'.$notice->pdf_file)}}">
                                </div>
