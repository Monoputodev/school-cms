            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Create Notice</h4>
                            ...
                            <form method="POST" action="{{ route('notices.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="row g-3">
                                  ...
                                  <div class="col-md-6">
                                    ...
                                    <input type="file" class="form-control dropify" id="pdf_file" name="pdf_file" data-default-file="{{ old('pdf_file') }}" required>
                                </div>
