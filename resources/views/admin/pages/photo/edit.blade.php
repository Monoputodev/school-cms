                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="ranking"
                                          value="{{ $photo->ranking }}" name="ranking" required>
                                    </div>
                                  <div class="col-md-6">
                                  ...
                                  <div class="col-md-6">
                                    ...
                                    <input type="file" class="form-control dropify" id="image" name="image" data-default-file="{{asset('uploads/photos/'.$photo->image)}}">
                                </div>
