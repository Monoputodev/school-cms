                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="gallery-img mb-30">
                            ...
                            <div class="gallery-view">
                                <a class="img-poppu" href="{{ asset('') }}assets/web/images/gallery/1.jpg">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="gallery-img mb-30">
                            ...
                            <div class="gallery-view">
                                <a class="img-poppu" href="{{ asset('') }}assets/web/images/gallery/2.jpg">
                                    <i class="fa fa-search-plus"></i>
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="gallery-img mb-30">
                            ...
                            <div class="gallery-view">
                                <a class="img-poppu" href="{{ asset('') }}assets/web/images/gallery/3.jpg">
                                    <i class="fa fa-search-plus"></i>
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="gallery-img mb-30">
                            ...
                            <div class="gallery-view">
                                <a class="img-poppu" href="{{ asset('') }}assets/web/images/gallery/4.jpg">
                                    <i class="fa fa-search-plus"></i>
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="gallery-img mb-30">
                            ...
                            <div class="gallery-view">
                                <a class="img-poppu" href="{{ asset('') }}assets/web/images/gallery/5.jpg">
                                    <i class="fa fa-search-plus"></i>
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="gallery-img mb-30">
                            ...
                            <div class="gallery-view">
                                <a class="img-poppu" href="{{ asset('') }}assets/web/images/gallery/6.jpg">
                                    <i class="fa fa-search-plus"></i>
                                </a>
                            </div>
                        </div>
