<div id="side-panel" class="dark layer-overlay overlay-white-8" data-bg-img="images/bg/bg1.jpg">
    <div class="side-panel-wrap">
        <div id="side-panel-trigger-close" class="side-panel-trigger"><a href="#"><i
                    class="icon_close font-30"></i></a></div>
        <div class="side-panel-widget">
            <div class="widget">
                <a href="javascript:void(0)"><img alt="logo"
                        src="{{ asset('/') }}/assets/web/images/logo-wide.png"></a>
                <p class="mt-20">Lorem ipsum dolor sit amet, consect etur adipisi cing elit commodi molestiae autem
                    fugit consectetur dolor ullam illo ipsa numquam quod iusto enim ipsum amet iusto amet consec.
                </p>
            </div>
            <div class="widget">
            ...
            <div class="widget">
                ...
                <ul>
                    <li class="font-14 mb-5"><i class="fa fa-phone text-theme-colored"></i> <a href="#"
                            class="text-gray">{{ $content->website_phone }}</a> </li>
                    <li class="font-14 mb-5"><i class="fa fa-globe text-theme-colored"></i> <a class="text-gray"
                            href="#">www.yourdomain.com</a></li>
                    <li class="font-14 mb-5"><i class="fa fa-envelope-o text-theme-colored"></i> <a
                            href="#" class="text-gray">{{ $content->website_email }}</a> </li>
                </ul>
            </div>
            <div class="widget">
