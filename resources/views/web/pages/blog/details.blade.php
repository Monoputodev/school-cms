                            ...
                            <div class="single-sidebar tags">
                                ...
                                <ul>
                                    @foreach ($services as $service)
                                        <li><a href="{{ route('service.package', $service->title) }}">{{ $service->title }}
                                                <span> ({{ $service->packages->count() }})</span></a>
                                        </li>
                                    @endforeach
                                </ul>
                            </div>
                            ...
                            <div class="single-sidebar latest">
                                ...
                                @foreach ($blogs as $blog)
                                    <div class="single-post">
                                        <div class="post-info">
                                            <h4><a href="{{ route('blog.details', $blog->title) }}">{{ $blog->title }}</a>
                                            </h4>
                            ...
                            <div class="single-sidebar category">
                                ...
                                <ul>
                                    @foreach ($packages->take(5) as $package)
                                        <li><a href="{{ route('package.details', $package->title) }}"><i
                                                    class="fa fa-angle-double-right"></i>{{ $package->title }}</a>
                                        </li>
                                    @endforeach
