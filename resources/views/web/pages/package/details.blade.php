...
<div class="main-body">
    ...
    <section class="breadcrumb-blog-version-one">
        <div class="single-bredcurms"
          style="background-image:url('{{ asset('uploads/services/' . $package->service->image) }}');">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                    ...
                    <div class="single-package-details">
                        ...
                        <div class="package-features-image">
                            <img src="{{ asset('uploads/packages/' . $package->image) }}" alt=""
                              class="img-responsove border-raduis-3">
                        </div>
                        <h2 class="price"> <b> Price :</b> {{ $package->price }}</h2>
                    </div><!-- tab menu strat -->
                        ...
                        <div class="tab-content">
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="map">
                                <div class="row">
                                    <div class="col-md-12 col-sm-12">
                                        <div class="tour-description">
                                            <h4>Tour Benefits and Policy</h4>
                    ...
                    <aside>
                        <div class="booking-form">
                            ...
                            <form action="{{ route('package-query.store') }}" method="post">
                                ...
                                <div class="form-group">
                                    <textarea name="messege" id="messege" cols="30" rows="10" class="form-control"
                    ...
                    <div class="adding-form">
                        <div class="addfor-bg">
                            <div class="add-content">
                                <h3>Islami Bank Bangladesh Limited
                                </h3>

                                <ul class="contact-for-add">
                                    <li> <b>A/C Name:</b>  S M Travels International
                                    </li>
                                    <li><b> A/C Number:</b> 20502740100247518
                                        <br>
                                        Islami Bank Bangladesh Ltd.
                                        <br>
                                        Pallabi Branch
                                    </li>
                                    <li> <b> Swift Code:</b> IBBLBDDH
                                    </li>
                                    <li><b>Routing Number:</b> 125263580
                                    </li>
                                </ul>
                            </div>
                            <div class="add-content">
                                <h3>United Commercial Bank Ltd
                                </h3>

                                <ul class="contact-for-add">
                                    <li><b>A/C Name:</b> M/S S.M. TRAVELS INTERNATIONAL

                                    </li>
                                    <li><b> A/C Number:</b> 1072101000002441
                                        <br>
                                        United Commercial Bank Ltd
                                        <br>
                                        Bijaynagar Branch
                                    </li>
                                    <li> <b> Swift Code:</b> UCBLBDDHBJN
                                    </li>
                                    <li><b>Routing Number:</b> 245271094
                                    </li>
                                </ul>
                            </div>
                        </div>
