...
<div class="main-body">
    ...
    <section class="breadcrumb-blog-version-one">
        <div class="single-bredcurms" style="background:#006bc7;">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                                ...
                                <ul class="two-column">
                                    <li>
                                        <div class="package-long-btn hvr-shutter-out-horizontal">
                                            <a href="{{ route('package.details', $package->title) }}">Details</a>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="package-long-btn" style="background: #006bc7">
                                            <a href="#" data-toggle="modal"
                                              data-target="#exampleModal{{ $package->id }}">Book Now</a>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <aside>
                        <div class="booking-form">
                            ...
                            <form action="{{ route('package-query.store') }}" method="post">
                                ...
                                <div class="form-group">
                                    <textarea name="messege" name="message" id="message" cols="30" rows="10"
